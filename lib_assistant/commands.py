...
Command(["turn off", "turnoff", "off", "stop", "go to sleep", "stop listening", "die"],
        func_name="end",
...
Command(["maximize", "maximus", "max", "enlarge"],
        func_name="maximize"),
Command(["reset"], func_name="reset"),

###########################
### Unfinished commands ###
###########################

Mode_Command(["safe", "said"], func_name="start_safe_mode", name="safe"),
